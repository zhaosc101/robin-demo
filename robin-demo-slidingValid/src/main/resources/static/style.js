(function (window, document) {
    var SliderBar = function (targetDom, options) {
        ...
        var html = "<div class='slide-box'><div class='slide-img-block'>" +
            ...
            "<div class='slide-title' id='slideHint'> <-按住滑块，拖动完成上面拼图</div><input hidden id='sessionId'/></div></div>";
        ...
        this.sessionId = document.getElementById("sessionId");       // 弹出
        this.resultX = 0;
        this.startX = 0;
        this.timer = 0;
        this.startTamp = 0;
    ...
    SliderBar.prototype = {
        ...
        reToNewImg: function () {
            ...
            _this.sessionId.setAttribute("value", coordinates.sessionId);
            _this.slideImg.onload = function (e) {
                ...
                _this.slideBlock.style.top = coordinates.yPoint  * _this.imgHeightMultiple +"px";
